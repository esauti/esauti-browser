...
export function enableFocus(opts: BrowserClientOptions, focus: FocusOptions): () => void {
...
export function refreshFocus(opts: BrowserClientOptions, focusId: string): void {
